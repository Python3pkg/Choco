...
<head>
<title><%block name="head_title">Choco Templates for Python</%block></title>
...
<body>
    ...
    <a href="${site_base}/"><img src="${pathto('_static/chocoLogo.png', 1)}" /></a>
...
<div class="copyright">Website content copyright &copy; by Michael Bayer.
    All rights reserved.  Choco and its documentation are licensed
